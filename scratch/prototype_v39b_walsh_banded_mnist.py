...
class BandedWalshMNIST(nn.Module):
    """
    V39b: The Banded Walsh Equalizer (Low LR).
...
def main():
    ...
    print(f"Training V39b 'BANDED WALSH EQUALIZER' (Low LR 0.001) on: {device}")
    
    BATCH_SIZE = 128
    EPOCHS = 10
    LR = 0.0001 # Reduced LR to prevent catastrophic forgetting
