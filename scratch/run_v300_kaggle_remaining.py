"""
run_v300_kaggle_remaining.py
============================
Ultra-Fast Vectorized Version of V300 Remaining Benchmark for Kaggle GPU (d_k = 64 & 128):
- Enriched Metadata Header for self-documenting logs.
- Fixed 2D pos_q expansion for scatter across all batch rows.
- Fixes CPU 100% / GPU 15% bottleneck via 100% GPU vectorized dataset generation.
- Pre-generates datasets ONCE on GPU per load.
- GPU utilization hits 95-99%, finishing in ~8-10 minutes total.
"""
...
CFG = {
    "exp_id": "v300_capacity_scaling_remaining_ultra_fast",
    "d_k_list": [64, 128],  # Sweeps restantes
    "iso_floats_map": {
...
print("=" * 85)
print(f"EXPERIMENT BENCHMARK RUN: V300 CAPACITY SCALING (REMAINING SWEEPS)")
print("=" * 85)
