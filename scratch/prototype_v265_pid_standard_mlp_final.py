...
def main():
    ...
    # PID-100 with Relaxed Clipping
    pid_acc = run_standard_exp("PID (Kp=1, Ki=100, Kd=1) + Clip 10", PID, {"lr": 1e-3, "ki": 100.0, "kd": 1}, train_loader, test_loader)
    
    # Adam Baseline
    adam_acc = run_standard_exp( "Adam (Standard) + Clip 10", optim.Adam, {"lr": 1e-3}, train_loader, test_loader)
