...
def visualize():
    ...
    fig.suptitle("Grid Initialization Test (v57) - 16x16 Matchsticks", fontsize=16)
    for i in range(256):
        ax = axes[i // 16, i % 16]
    ...
    plt.savefig("v57_grid_gallery.png", dpi=150)
    print("🎨 Gallery saved as v57_grid_gallery.png")
    plt.show()
