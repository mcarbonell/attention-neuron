...
def main():
    ...
    # 1. Industrial PID (Best from v267)
    pid_res = run_experiment(
        "Industrial PID (Kp=1, Ki=100, Kd=10)", 
        PID, 
        {"lr": 1e-3, "kp": 1.0, "ki": 100.0, "kd": 10.0}, 
    ...
    # Summary
    print("\n" + "="*50)
    print("CIFAR-10 VALIDATION SUMMARY")
    print("="*50)
    ...
    with open(f"results/raw/cifar10_pid_v268_{timestamp}.json", "w") as f:
