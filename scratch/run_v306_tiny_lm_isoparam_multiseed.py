"""
run_v306_tiny_lm_isoparam_multiseed.py
======================================
V306 Tiny LM Benchmark: Strict Iso-Parameters & Multi-Seed (n=5) Validation.

Promotes Language Modeling findings to Level 2 [ANCLA] by evaluating:
  1. Strict Iso-Parameters: ComplexDeltaPhase and RealDeltaNet matching at EXACTLY 144,331 params.
  2. Multi-Seed Robustness: 5 independent seeds [10, 20, 30, 42, 100].
  3. Standard Error (SE) reporting: Mean PPL +- SE.
  4. 5% Linear LR Warmup scheduler.

Usage:
  python scratch/run_v306_tiny_lm_isoparam_multiseed.py --mode lite
  python scratch/run_v306_tiny_lm_isoparam_multiseed.py --mode normal --device cuda
"""
...
parser = argparse.ArgumentParser(description="V306 Tiny LM Iso-Parametric Multi-Seed Benchmark")
...
CONFIGS = {
    ...
    "normal": {
        "exp_id": "v306_tiny_lm_isoparam_normal",
        "seeds": [10, 20, 30, 42, 100],
        "seq_len": 384,
        "batch_size": 32,
        "chunk_size": 64,
...
# ── 3. Training Loop with LR Warmup ─────────────────────────────────────
...
print("=" * 85)
print(f"{ts()} EXPERIMENT: V306 TINY LM ISO-PARAMETRIC MULTI-SEED ({args.mode.upper()})")
print("=" * 85)
...
# Find strictly best model by Mean Val Loss / PPL
...
output_file = f"v306_tiny_lm_isoparam_{args.mode}_results.json"
