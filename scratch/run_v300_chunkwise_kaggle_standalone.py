"""
run_v300_chunkwise_kaggle_standalone.py
=======================================
100% Standalone Self-Contained Version of V300 Chunkwise Benchmark for Kaggle GPU.
Contains all block definitions inline - no external package imports or git clones required!
Runs in ~4-5 minutes on Kaggle T4 GPU.
"""
...
CFG = {
    "exp_id": "v300_capacity_scaling_chunkwise_standalone",
    "d_k_list": [32, 64, 128],
    "iso_floats_map": {
...
print("=" * 85)
print(f"EXPERIMENT BENCHMARK RUN: V300 STANDALONE CHUNKWISE PARALLEL CAPACITY SCALING")
print("=" * 85)
...
with open("v300_chunkwise_standalone_capacity_scaling_results.json", "w") as f:
    json.dump({"config": CFG, "results": results_matrix}, f, indent=2)
print("\nBENCHMARK COMPLETE! Results saved to v300_chunkwise_standalone_capacity_scaling_results.json", flush=True)
