# ============================================================================
# V304 TINY LANGUAGE MODELING BENCHMARK — Kaggle/Colab Single-Cell Version
# ============================================================================
# CONFIGURE HERE: "lite" (~10-15 min on T4) or "normal" (~45-60 min on T4)
MODE = "lite"
SEED = 42
# ============================================================================
...
print("=" * 85)
print(f"{ts()} EXPERIMENT: V304 TINY LANGUAGE MODELING BENCHMARK ({MODE.upper()})")
print("=" * 85)
...
output_file = f"v304_tiny_lm_{MODE}_results.json"
