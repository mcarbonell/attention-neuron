"""
scratch/benchmark_sign_ds_mnist.py — Memory Ultra-Light Benchmark (Sign-DS First)
"""
...
# Sign-DS suele requerir un LR muy bajo como Lion, quizá incluso más
hist_sign_ds, dur_sign_ds = train_model("Sign-DS (2b/p - Candidate)", SignDS, lr=1e-4, alpha=0.5)
...
plt.savefig('results/figures/sign_ds_comparison.png')
print(f"\nBenchmark finalizado.")
print(f"Tiempos: Sign-DS {dur_sign_ds:.1f}s, Lion-DS {dur_lion_ds:.1f}s, Adam {dur_adam:.1f}s")
plt.show()
