# ============================================================================
# V307 TINYSTORIES SUBWORD BPE BENCHMARK — Kaggle/Colab Single-Cell Version
# ============================================================================
MODE = "lite"
...
print("=" * 85)
print(f"{ts()} EXPERIMENT: V307 TINYSTORIES SUBWORD BPE BENCHMARK ({MODE.upper()})")
print("=" * 85)
...
output_file = f"v307_tinystories_bpe_{MODE}_results.json"
