"""
run_v305_debug_harness_mqar.py
==============================
V305 Debug & Certification of Synthetic MQAR Harness.

Fixes potential optimization instabilities in MQAR synthetic benchmarks by:
  1. Adding a 5% Linear LR Warmup scheduler.
  2. Bisecting sequence lengths L in [128, 256, 512, 1024].
  3. Comparing WITH Warmup vs WITHOUT Warmup to certify if Softmax MHA and Real
     controls recover from synthetic collapse at L > 500.

Usage:
  python scratch/run_v305_debug_harness_mqar.py --mode lite
  python scratch/run_v305_debug_harness_mqar.py --mode normal --device cuda
"""
...
parser = argparse.ArgumentParser(description="V305 MQAR Harness Certification")
...
# ── 3. Training Loop with Linear LR Warmup ─────────────────────────────
...
print("=" * 85)
print(f"{ts()} EXPERIMENT: V305 MQAR HARNESS CERTIFICATION ({args.mode.upper()})")
print("=" * 85)
...
output_file = f"v305_debug_mqar_{args.mode}_results.json"
