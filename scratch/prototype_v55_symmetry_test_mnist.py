...
class LineNeuronLayer(nn.Module):
    def __init__(self, num_neurons=256):
        ...
        # FIXED INITIALIZATION: All neurons start as a vertical line in the center
        # p0 = (14, 7), p1 = (14, 21)
...
class LineNet(nn.Module):
    def __init__(self, num_neurons=256):
        ...
        # Note: The classifier IS randomly initialized, which will break the symmetry
...
def train():
    ...
    print(f"--- V55: SYMMETRY BREAK TEST (ALL VERTICAL INIT) ---")
    
    NUM_NEURONS = 256
    EPOCHS = 100
    LR = 0.02 # Using a moderate LR
    ...
    metrics = {"experiment": "v55_symmetry_test", "best_objective": max(history), "history_acc": history}
    with open("results/raw/v55_symmetry_test.json", "w") as f: json.dump(metrics, f, indent=4)
    
    torch.save(model.state_dict(), "v55_symmetry.pth")
    print("✅ Model saved as v55_symmetry.pth")
