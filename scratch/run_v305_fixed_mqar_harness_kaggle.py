# ============================================================================
# V305 FIXED MQAR HARNESS BENCHMARK — Kaggle/Colab Single-Cell Version
# ============================================================================
MODE = "lite"
SEED = 42
# ============================================================================
...
print("=" * 85)
print(f"{ts()} CERTIFIED BENCHMARK: V305 FIXED MQAR HARNESS ({MODE.upper()})")
print("=" * 85)
...
output_file = f"v305_fixed_mqar_{MODE}_results.json"
