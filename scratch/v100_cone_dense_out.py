...
class ConeNetDenseOut(nn.Module):
    def __init__(self, hidden_size=256):
        super().__init__()
        self.flatten = nn.Flatten()
        # Capa 1: Cono 2D (Extracción de características espaciales)
        self.layer1 = ConeAttention2DLayer(28, 28, hidden_size)
        # Capa 2: Densa estándar para la clasificación
...
def train():
    ...
    model = ConeNetDenseOut(hidden_size=256).to(device)
