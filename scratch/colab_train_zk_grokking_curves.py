"""
colab_train_zk_grokking_curves.py
=================================
Colab Tesla T4 GPU Script for Z_k Grokking Phase Transition Curves & Steps-to-Solve.
...
def print_log_header(device):
    print("===============================================================================================", flush=True)
    print("        COLAB TESLA T4: Z_k GROKKING PHASE TRANSITION CURVES & STEPS-TO-SOLVE                 ", flush=True)
    print("===============================================================================================", flush=True)
...
def train_and_extract_curve(block_cls, name, modulo=7, steps=3000, log_every=50, device='cpu'):
    ...
    curve = [] # (step, loss, train_acc, steps_to_50, steps_to_80)
    step_50_acc = None
    step_80_acc = None
...
def main():
    ...
    target_modulos = [7, 9, 12] # Z_7 (Odd Prime), Z_9 (Odd Composite 3^2), Z_12 (Even Composite)
    steps_total = 3000
    ...
    print("\n" + "=" * 125, flush=True)
    print("COLAB GPU SUMMARY: GROKKING PHASE TRANSITION & STEPS-TO-SOLVE AUDIT", flush=True)
